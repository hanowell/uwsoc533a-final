...
**Not following these instructions may result in you doing more work than you need to do. It may also result in deduction of points, but most likely I'll just ask you to correct the error and turn in an amended final for full credit.**
...
**Annual period age-specific birth counts on January 1st  for the U.S. from 1933 through 2016.**
...
**Annual period age-specific death counts for the U.S. from 1933 through 2016.**
...
**Annual period age-specific person-year (ASPY) approximations by sex for the U.S. from 1933 through 2016.**
...
**Age-specific population counts by sex and day of year (January 1st vs. December 31st) for the U.S. from 1933 through 2016.**
...
**Report the CGR results for 2005 through 2015 for the total population (both sexes combined) in a table below with the following structure:**
...
**For both sexes combined, compute the principal period rates that contributed to the CGR (not age-specific) for each calendar-year period from 2005 through 2015. Hint: For each year, you will have to infer the crude rate of net migration (CRNM) because you can't calculate it directly.**
...
**Within the context of the intervening Great Recession and its aftermath, interpret the age-specific and total decompositions of the change in CDR from 2005 to 2015. Make explicit reference to the interpretation of the signs and magnitudes of the effects themselves. Highlight any differences in the effects by sex that stand out to you, being specific about what the differences in the effects mean.**
